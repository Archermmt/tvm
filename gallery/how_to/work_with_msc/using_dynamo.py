...
parser = argparse.ArgumentParser(description="MSC dynamo example")
parser.add_argument(
    "--dataset",
    type=str,
...
def get_config():
    ...
    return DynamoWrapper.create_config(
        compile_type=args.compile_type, tools=tools, verbose=args.verbose
    )
...
if __name__ == "__main__":
    ...
    # save datasets
    with model.save_datas(MSCStage.PREPARE):

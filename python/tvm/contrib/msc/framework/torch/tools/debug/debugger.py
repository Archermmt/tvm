...
# under the License.
"""tvm.contrib.msc.framework.torch.tools.debug.debugger"""
...
class TorchDebuggerFactory(object):
    """Debugger factory for torch"""

    def create(self, base_cls: BaseDebugger):
        class debugger(base_cls):
            """Adaptive debugger for torch"""
